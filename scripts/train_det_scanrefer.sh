...
###
 ...
 # @LastEditTime: 2023-03-30 17:48:32
 # @LastEditors: daniel
 # @Description: 
 # @FilePath: /butd_detr/scripts/train_det_scanrefer.sh
 # have a nice day
### 
...
b_size='8,4';
resume_model_path=/data3/xusc/exp/butd_detr/logs/bdetr/discover01/scanrefer/ttpg_pretrain_20_labeled/ckpt_epoch_399_best.pth;
labeled_ratio=0.2;
topk=8;
epoch=1000;
decay_epoch="65";
