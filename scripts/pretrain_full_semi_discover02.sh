...
###
 ...
 # @LastEditTime: 2023-04-30 10:12:01
 # @LastEditors: daniel
 # @Description: 
 # @FilePath: /butd_detr/scripts/pretrain_full_semi_discover02.sh
 # have a nice day
### 
...
#* student_Metrics/Acc@0.25-top1:0.3286,student_Metrics/Acc@0.5-top1:0.1981
resume_model_path=/home/DISCOVER_summer2022/xusc/exp/butd_detr/logs/bdetr/scanrefer/1682318366/ckpt_epoch_714_best.pth; 
...
#     --checkpoint_path $resume_model_path --lr_decay_intermediate --eval \
...
TORCH_DISTRIBUTED_DEBUG=INFO CUDA_VISIBLE_DEVICES=$gpu_ids \
    ...
    --labeled_ratio $labeled_ratio --lr_decay_epochs $decay_epoch --use-tkps --max_epoch 2000 --wandb \
