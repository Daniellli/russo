...
from .arkit_box_util import compute_box_3d, boxes_to_corners_3d, get_size
...
class TenFpsDataLoader(object):
    def __init__(
        ...
        traj_file = os.path.join(self.root_path, 'lowres_wide.traj')#* 相机位姿
        ...
        for frame_id in self.frame_ids:
            ...
            if not os.path.exists(intrinsic_fn):
                ...
                print(intrinsic_fn)
            self.intrinsics[frame_id] = st2_camera_intrinsics(intrinsic_fn)#* 每个位姿的相机内参
